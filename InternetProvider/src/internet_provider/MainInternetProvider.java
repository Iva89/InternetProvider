...
public class MainInternetProvider {
	...
	public static void main(String[] args) {
		...
		TariffAddOn facebook = new TariffAddOn(200.00, AddOnsType.FACEBOOK);
		postCustomer1.addTariffAddOns(facebook);
		
		System.out.println(postCustomer1.getName() + " adding instagram:");
		
		TariffAddOn instagram = new TariffAddOn(200.00, AddOnsType.INSTAGRAM);
		...
		TariffAddOn fixedTel = new TariffAddOn(500.00, AddOnsType.FIXED_TELEPHONY);
